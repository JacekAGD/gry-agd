...
// Wymagane dla Browserless.
$browserlessToken = 'YOUR_BROWSERLESS_TOKEN';

if ($login === 'YOUR_LOGIN' || $pass === 'YOUR_PASSWORD') {
    echo "Uzupełnij zmienne login i pass w pliku login.php\n";
    exit(1);
}

if ($browserlessToken === 'YOUR_BROWSERLESS_TOKEN') {
    echo "Uzupełnij zmienną browserlessToken w pliku login.php\n";
    exit(1);
}
...
(async () => {
  ...
  try {
    ...
    throw new Error('Brak modułu "playwright-core". Uruchom: npm install playwright-core');
  }
